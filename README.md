...
- manual Claude Code CLI `2.1.226` and `2.1.233` certification for Messages single Bash-tool, dependent two-tool, and error-recovery round trips, plus Claude Code CLI `2.1.235` certification for those scenarios and a dependent three-tool loop, with `nvidia/nemotron-3-super-120b-a12b`
...
3. Broaden Claude Code/Messages certification beyond the current single-tool, dependent two-tool, dependent three-tool, and error-recovery profiles to additional client versions, models, parallel tools, and longer multi-turn patterns.
