...
| `AGENTINTERPOSER_FALLBACK_MODELS` | none | Ordered comma-separated same-upstream fallback model IDs; used for certified vision routing and simple text Responses fallback |
...
5. Expand the initial same-upstream fallback into structured/tool-bearing Responses routing and multi-provider routing.
